...
fun FragmentActivity.requestPermission(requestCode: Int, vararg permission: String) {
...
fun Fragment.requestPermission(requestCode: Int, vararg permission: String) {
    PermissionDialogFragment().apply {
        arguments = bundleOf(
            PermissionDialogFragment.PERMISSIONS to ArrayList(permission.toList()),
            PermissionDialogFragment.REQUEST_CODE to requestCode
