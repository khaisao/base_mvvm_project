...
class HomePageFragment :
    ...
    ConfirmDialogListener, NoticeDialogListener, PermissionListener {
    ...
    override fun onClickOk(type: Int?) {
        getString(com.example.core.R.string.ok).toast(requireContext())
    }

    override fun onClickCancel(type: Int?) {
        getString(com.example.core.R.string.cancel).toast(requireContext())
    }

    override fun onPermissionGranted(requestCode: Int?) {
        "onPermissionGranted".toast(requireContext())
    }
    ...
    override fun onPermissionDenied(
        ...
        "onPermissionDenied".toast(requireContext())
    }
